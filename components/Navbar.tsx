...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="md:flex">
          ...
          <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
            <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
              ...
              <p onClick={handleOpenLogin} className="cursor-pointer block text-gray-700 hover:text-gray-900">
                Log in
              </p>
              <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex" onClick={handleOpenRegistration}>
                Sign in
      ...
      {/* Popup */}
      {isOpen && (
        <div className='modal-container absolute top-10 bg-[#FFFFFF]  border p-14 max-w-96 z-10'>
          <main className="w-full absolute mt-4 flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-5">
              ...
              >
                ...
                <button
                  className="w-full px-4 py-2 text-white font-medium bg-[#072541] hover:bg-[#435585] active:bg-indigo-600 duration-150"
                >
                  Sign in
                </button>
              </form>
      ...
      {isOpen2 && (
        <main className="w-full flex modal-container absolute top-10 bg-[#FFFFFF]  border p-14 max-w-96 z-10">
          <div className="flex-1 flex items-center justify-center">
            <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
              ...
              >
                ...
                <button
                  className="w-full px-4 py-2 text-white font-medium hover:bg-[#435585] bg-[#072540] duration-150"
                >
                  Registration
                </button>
          ...
          <button onClick={handleClose2} className='close cursor-pointer border bg-[#072541] px-4 text-end py-1 text-white absolute right-4 top-4'>Close</button>
