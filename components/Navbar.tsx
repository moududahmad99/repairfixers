...
const Navbar: React.FC = () => {
  ...
  const tabItems = ["Login", "Registration"];
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="navbar-frontend container mx-auto navbar flex items-center justify-between bg-white p-4">
        <div>
          <picture>
            <Image src={image} height="100" width="200" alt="logo" />
          </picture>
        </div>
        <div>
          <Link className='font-semibold text-md mx-2 hover:underline' href="/">Home</Link>
          <Link className='font-semibold text-md mx-2 hover:underline' href="/about">About Us</Link>
          <button className='font-semibold text-md mx-2 hover:underline' onClick={handleOpen}>Login</button>
          <select className="ml-4 bg-[#201F1C] text-white outline-none px-6 py-2 text-sm">
            <option value="bn" className="bg-white text-black">Bangla</option>
      ...
      {isOpen && (
        ...
        <Tabs.Root
          className="max-w-screen-xl react-tab mx-auto px-4 md:px-8 modal-container absolute top-10 bg-[#FFFFFF]  border p-14 max-w-96 z-10"
          defaultValue="Login"
        >
          <Tabs.List
          ...
          >
            {tabItems.map((item, idx) => (
              <Tabs.Trigger
                ...
                value={item}
              >
                <div className="py-1.5 px-3  duration-150 group-hover:text-indigo-600 group-hover:bg-gray-50 group-active:bg-gray-100 font-medium">
                  {item}
                </div>
              </Tabs.Trigger>
            ))}
          ...
          {tabItems.map((item, idx) => (
            <Tabs.Content key={idx} className="py-6" value={item}>
              <div>
                {item === "Login" ? (
                  <div>
                    <main className="w-full mt-4 flex flex-col items-center justify-center px-4">
                      <div className="max-w-sm w-full text-gray-600 space-y-5">
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center gap-x-3">
                              ...
                              <label
                                ...
                                className="relative flex w-5 h-5 bg-white peer-checked:bg-indigo-600 border ring-offset-2 ring-indigo-600 duration-150 peer-active:ring cursor-pointer after:absolute after:inset-x-0 after:top-[3px] after:m-auto after:w-1.5 after:h-2.5 after:border-r-2 after:border-b-2 after:border-white after:rotate-45"
                              >
                              </label>
                          ...
                          <button
                            className="w-full px-4 py-2 text-white font-medium bg-[#072541] hover:bg-indigo-500 active:bg-indigo-600 duration-150"
                          >
                            Sign in
                          </button>
                        </form>
                        <button className="w-full flex items-center justify-center gap-x-3 py-2.5 border text-sm font-medium hover:bg-gray-50 duration-150 active:bg-gray-100">
                        ...
                        {/* <p className="text-center">Dont have an account? <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500" onClick={handleClose}>Sign up</a></p> */}
                      </div>
                    </main>

                    <button onClick={handleClose} className='close cursor-pointer border bg-[#072541] px-4 text-end py-1 text-white absolute right-4 top-4'>Close</button>
                  </div>
                ) : (
                  <main className="w-full flex">
                    ...
                    <div className="flex-1 flex items-center justify-center">
                      <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                        <h2 className='font-semibold text-2xl text-center'>Create a New Account</h2>
                        <div className="grid grid-cols-3 gap-x-3">
                          <button className="flex items-center justify-center py-2.5 border  hover:bg-gray-50 duration-150 active:bg-gray-100">
                            <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <g clip-path="url(#clip0_17_40)">
                                <path d="M47.532 24.5528C47.532 22.9214 47.3997 21.2811 47.1175 19.6761H24.48V28.9181H37.4434C36.9055 31.8988 35.177 34.5356 32.6461 36.2111V42.2078H40.3801C44.9217 38.0278 47.532 31.8547 47.532 24.5528Z" fill="#4285F4" />
                                <path d="M24.48 48.0016C30.9529 48.0016 36.4116 45.8764 40.3888 42.2078L32.6549 36.2111C30.5031 37.675 27.7252 38.5039 24.4888 38.5039C18.2275 38.5039 12.9187 34.2798 11.0139 28.6006H3.03296V34.7825C7.10718 42.8868 15.4056 48.0016 24.48 48.0016Z" fill="#34A853" />
                        ...
                        >
                          ...
                          <button
                            className="w-full px-4 py-2 text-white font-medium hover:bg-[#072541] bg-[#072540] duration-150"
                          >
                            Registration
                          </button>
